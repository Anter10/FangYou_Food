...
/**
 * Created by guoyouchao on 16/5/17.
 */
...
public class ListCell extends BaseAdapter {
    ...
    public ListCell(Context context, List<Map<String, Object>> data){
...
//            zujian.image=(ImageView)convertView.findViewById(R.id.image);
            ...
            zujian.view.setFocusable(false);

            zujian.view.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                                       Toast.makeText(v.getContext(),"你好按钮" , Toast.LENGTH_SHORT).show();
